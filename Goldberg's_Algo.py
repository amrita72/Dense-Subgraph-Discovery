...
number_of_nodes = int(input("Enter number of nodes: ")) + 1
number_of_edges = int(input("Enter number of edges: "))

start_time = time.clock()
answer = Find_Densest_Subgraph(number_of_nodes, number_of_edges)
print ('Time elapsed is: ',time.clock() - start_time)
print("The subgraph is:", end = ' ')
print (answer)
print("Density of the subgraph:", end = ' ')
Find_Density(answer)